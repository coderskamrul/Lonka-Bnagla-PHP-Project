...
// $sql = "SELECT *
// FROM ((`customer_two` 
//       INNER JOIN `customer_four` ON customer_two.four = customer_four.four)
//       INNER JOIN customer_five ON customer_two.four = customer_five.one)
//       WHERE customer_two.Id = 7;";
//SQL end
  ...
  <div class="profile-nav col-md-3">
      <div class="panel">
          <div class="user-heading round">
              ...
              <h1><?php echo $row['boApplication'] ?></h1>
              <p><?php echo $row['boEmail'] ?></p>
