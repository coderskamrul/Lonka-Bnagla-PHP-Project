            ...
            <form action="#">
                <div class="row d-flex">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="input10">Issue Place:</label>
                            <input type="text" class="form-control" id="input10">
                        </div>
                        <div class="form-group">
                            <label for="input10">Issue Date:</label>
                            <input type="text" class="form-control" id="input10">
                        </div>
                        <div class="form-group">
                            <label for="input10">Expire Date:</label>
                            <input type="text" class="form-control" id="input10">
                        </div>

                        <div class="form-group">
                            <label for="input10">Bank Name:</label>
                            <input type="text" class="form-control" id="input10">
                        </div>
                        <div class="form-group">
                            <label for="input10">Branch Name:</label>
                            <input type="text" class="form-control" id="input10">
                        </div>
                        <div class="form-group">
                            <label for="input10">Account No:</label>
                            <input type="text" class="form-control" id="input10">
                        </div>
                        <div class="form-group">
                            <label for="input10">Routing No:</label>
                            <input type="text" class="form-control" id="input10">
                        </div>
